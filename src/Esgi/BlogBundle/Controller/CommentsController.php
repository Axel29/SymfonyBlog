...
class CommentsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EsgiBlogBundle:Comments')->findAll();

        return $this->render('EsgiBlogBundle:Comments:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EsgiBlogBundle:Comments')->find($id);
        ...
        return $this->render('EsgiBlogBundle:Comments:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EsgiBlogBundle:Comments:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new CommentsType(), $entity, array(
            'action' => $this->generateUrl('esgi_blog_comments_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('esgi_blog_comments_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('esgi_blog_comments'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('esgi_blog_comments_delete', array('id' => $id)))
            ->setMethod('DELETE')
